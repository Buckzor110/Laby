...
def IsFigured(n):
    ...
    while i <= n:
        if i == n:
            return True  # Фигурное
        else:
            i = ((5 * math.pow((counter), 2)) + 5 * (counter) + 2) / 2
            counter += 1
...
def Sequence():
    ...
    while True:
        ...
        if check == True:
            numYes += 1
            sumYes += num
            print('(', num, ')', Name1, '\bое', Name2, '\bое [ДА]')
        else:
            numNot += 1
            sumNot += num
    ...
    # Отображение итогов
    print('Чисел: всех = ', numAll, ',', Name1, '\bых', Name2, '\bых = ', numYes, ', прочих = ', numNot)
    print('Суммы: всех = ', sumAll, ',', Name1, '\bых', Name2, '\bых = ', sumYes, ', прочих = ', sumNot)
